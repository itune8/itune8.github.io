...
import { MapPin, FileDown, Github, Linkedin, ExternalLink, Play, Mail, Phone, ArrowRight, Code2, Briefcase, Award } from "lucide-react";
...
const ME = {
  name: "Sahil Kumar",
  description:
    "Front-End Engineer specializing in building exceptional digital experiences. Currently crafting innovative solutions at HyperBrain Labs and ensuring quality at Josh Technology Group.",
...
export default function Portfolio() {
  ...
  const projects = [
    {
      title: "AllowBox",
      desc: "Led 100% of front-end development for a scalable multi-tenant SaaS platform using React, Next.js, and Turborepo. Improved UI performance by ~40% and enhanced workflows across 4 major panels (Super Admin, School Admin, Teacher, Parent) resulting in ~30% faster navigation.",
      tags: ["React", "Next.js", "Turborepo"],
      icon: "🏫",
      video: null,
  ...
  {showResume && (
    ...
    >
      ...
      >
        ...
        <iframe
          src="https://drive.google.com/file/d/1uXfHXF4NcJq1R5li8U_gxunQOLxZZYWw/preview"
    ...
    >
      ...
      >
        ...
        <div className="space-y-6">
          ...
          >
            <h4 className="text-white font-semibold">FrontEnd Developer - Internship</h4>
            <p className="text-white/60 text-sm">HyperBrain Labs | Oct 2025 – Present</p>
          ...
          >
            <h4 className="text-white font-semibold">Software Test Engineer - Internship</h4>
            <p className="text-white/60 text-sm">Josh Technology Group | Jul 2025 – Nov 2025</p>
            <p className="text-white/70 text-sm mt-2">
          ...
          >
            <h4 className="text-white font-semibold">Salesforce Cloud Trainee - Apprentenship</h4>
            <p className="text-white/60 text-sm">PwC | Jul 2025 – Sep 2025</p>
            <p className="text-white/70 text-sm mt-2">
          ...
          <motion.div
            ...
            className="border-l-4 border-[#EC4899] pl-4"
          >
            <h4 className="text-white font-semibold">Web Developer - Internship</h4>
            <p className="text-white/60 text-sm">Showera | Nov 2024 – Feb 2025</p>
            <p className="text-white/70 text-sm mt-2">
              Designed and implemented backend architecture using the MVC design pattern, resulting in a 25% code maintainability and scalability improvement.
              Developed RESTful APIs for movie ticket booking and scanning, ensuring a seamless experience for users, organizers, and admins, leading to a 30% faster booking and scanning process.
              Created unified APIs to provide consistent user experiences across web and mobile platforms, improving cross-platform performance by 20% and reducing inconsistencies.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="border-l-4 border-[#F59E0B] pl-4"
          >
            <h4 className="text-white font-semibold">FrontEnd Developer - Internship</h4>
            <p className="text-white/60 text-sm">TailUX | Mar 2024 – Jun 2024</p>
            <p className="text-white/70 text-sm mt-2">
