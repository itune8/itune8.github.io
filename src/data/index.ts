...
export const stats = {
  ...
  projectsCount: "5+",
  hackathons: "3× Winner",
  hackathonsSubtitle: "1× Runner-up Ideathon",
  testSuites: "100+",
  testSuitesSubtitle: "Manual & Automated"
};
...
export const aboutContent = {
  paragraphs: [
    ...
    {
      text: "My journey in tech has been diverse - from developing full-stack applications to ensuring quality through rigorous testing.",
      highlights: [
        { text: "HyperBrain Labs", color: "accent" },
        { text: "Josh Technology Group", color: "accent" }
      ]
    },
    {
      text: "I'm particularly interested in SaaS platforms, performance optimization, and creating intuitive user interfaces that solve real-world problems."
    }
  ]
};
