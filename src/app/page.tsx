...
const experiences = [
  {
    ...
    description: [
      "Reduced application load time by 40% by leading Next.js-based frontend modernization, eliminating legacy grid components and optimizing rendering performance",
      "Improved authentication and payments reliability by 30% by implementing OAuth-based flows and Razorpay integrations across the platform",
      "Boosted operational efficiency by 35% by designing and deploying n8n automation workflows for events, notifications, and internal processes"
    ],
...
const projects = [
  {
    ...
    icon: "🏫",
    link: "https://allow-box-frontend-web.vercel.app/",
    featured: true
  },
  {
    id: 2,
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center px-6 pt-20 relative overflow-hidden">
        ...
        />
        <FloatingParticles />
        <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row gap-12 items-center relative z-10">
          <motion.div
          ...
          >
            ...
            >
              <motion.div
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 border border-white/10 backdrop-blur-sm cursor-pointer w-fit"
                whileHover={{
                  scale: 1.05,
            ...
            <div className="relative w-full aspect-square max-w-2xl mx-auto">
              ...
              <motion.div
                ...
                style={{
                  ...
                  backgroundImage: 'linear-gradient(#000000, #000000), linear-gradient(90deg, #7C3AED, #06B6D4, #7C3AED)',
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row gap-12">
              <motion.div
                className="flex-1 space-y-4 text-white/70 leading-relaxed"
              ...
              >
                ...
                >
                  ...
                  >Blend (Dubai - Remote)</motion.span>,
              ...
              <div className="flex flex-col gap-4 lg:w-1/2">
                {[
                  ...
                  >
                    <Card className="group cursor-pointer hover:border-cyan-400/50 hover:shadow-[0_0_20px_rgba(6,182,212,0.3)] transition-all">
            ...
            <div className="flex flex-col gap-6">
              {projects.map((project, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1 }}
                  className={project.featured ? 'w-full' : 'w-full lg:w-1/2'}
                >
                  <Card
                    className="group cursor-pointer hover:border-cyan-400/50 hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] transition-all h-full"
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              {Object.entries(skills).map(([category, items], index) => (
                <motion.div
                  ...
                  className="flex-1"
                >
                  <Card className="h-full hover:border-cyan-400/40 hover:shadow-[0_10px_30px_rgba(6,182,212,0.2)] transition-all">
                    <CardHeader>
                    ...
                    <CardContent>
                      <div className="flex flex-wrap gap-2">
                        {items.map((skill, i) => (
                          ...
                          >
                            <Badge className="cursor-pointer hover:bg-cyan-400/20 hover:border-cyan-400/80">
                              {skill}
                            </Badge>
                          </motion.div>
                        ))}
        ...
        {showResume && (
          ...
          >
            <motion.div
              ...
              className="bg-black p-6 rounded-2xl shadow-2xl border border-white/10 max-w-5xl w-full max-h-[90vh] overflow-hidden"
            >
        ...
        {activeProject && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.9, opacity: 0 }}
              className="bg-black p-8 rounded-2xl shadow-2xl border border-white/10 max-w-3xl w-full"
            >
